function [x, fval, exitflag, num_fun_evals] = Newton_method(fun, dfun_dx, x0, ...
    alpha, ...
    max_fun_evals, ...
    tolx, ...
    tolf)
%
% Newton method to solve fun(x) = 0, with damping factor alpha (multiplies the step)
% and seed x0. Returns [x, fval, exitflag, fun_evals].
%
